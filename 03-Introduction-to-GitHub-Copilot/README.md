...
- **Prerequisites**: To use GitHub Copilot you must have an active GitHub Copilot subscription. Sign up for the free tier here: [GitHub Copilot](https://gh.io/copilot)
